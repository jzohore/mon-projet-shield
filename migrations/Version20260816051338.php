 ...
 */
final class Version20260816051338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workspaces ALTER email SET NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workspaces ALTER email DROP NOT NULL');
    }
}
