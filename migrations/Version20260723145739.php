 ...
 */
final class Version20260723145739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE regulatory_profiles ADD last_chek_orias TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
    }
