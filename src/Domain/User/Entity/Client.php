...
#[ORM\Entity]
#[ORM\Table(name: '`clients`')] // Table séparée !
#[UniqueEntity(fields: ['email'], message: 'Un compte client existe déjà avec cet email.')]
class Client implements UserInterface, TwoFactorInterface
{
    ...
    public private(set) array $roles = ['ROLE_CLIENT'];
    ...
    /**
     * Les cabinets (Workspaces) avec lesquels ce client travaille.
     * ManyToMany car un client final peut avoir plusieurs CGP sur KYSURE.
     *
